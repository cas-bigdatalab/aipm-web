...
dictPath=os.path.join(settings.BASE_DIR,"service/tools/Sentiment/f_dict/")
class DictClassifier:
    def __init__(self):
        self.__root_filepath = dictPath

        jieba.load_userdict(os.path.join(dictPath,"user.dict"))  # 准备分词词典
