...
class ModelLanguage(): # 语音模型类
	...
	def LoadModel(self):
		...
		self.dict_pinyin = self.GetSymbolDict(asrPath+'/dict.txt')
		self.model1 = self.GetLanguageModel(asrPath+'/model_language/' + 'language_model1.txt')
		self.model2 = self.GetLanguageModel(asrPath+'/model_language/' + 'language_model2.txt')
		self.pinyin = self.GetPinyin(asrPath+'/model_language/' + 'dic_pinyin.txt')
